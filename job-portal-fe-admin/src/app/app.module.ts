...
@NgModule({
  declarations: [AppComponent, LoginComponent, UsersComponent, ApplicantsComponent, CompaniesComponent, JobPositionsComponent, ApplicationsComponent, CategoriesComponent],
  imports: [
    SharedModule,
    HttpClientModule,
    BrowserModule,
